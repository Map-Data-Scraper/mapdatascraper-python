...
class ApiClient(object):
    '''MapDataScraper ApiClient - Python SDK that allows using MapDataScraper's services and MapDataScraper's API.
    ```python
    ...
    def get_tasks(self, query: str = '', last_id: str = '', page_size: int = 10) -> Tuple[list, bool]:
        '''
            ...
            See: https://app.mapdatascraper.com/api-docs#tag/mapdatascraper-Platform-UI/paths/~1tasks/get
        '''
    ...
    def get_requests_history(self, type: str = 'running', skip: int = 0, page_size: int = 25) -> list:
        '''
            ...
            See: https://app.mapdatascraper.com/api-docs#tag/Requests/paths/~1requests/get
        '''
    ...
    def get_request_archive(self, request_id: str) -> dict:
        '''
            ...
            See: https://app.mapdatascraper.com/api-docs#tag/Requests/paths/~1requests~1{requestId}/get
        '''
    ...
    def google_maps_search(self, query: Union[list, str], limit: int = 20, drop_duplicates: bool = False,
        ...
        '''
            ...
            The results from searches are the same as you would see by visiting a regular Google Maps site. However, in most cases, it's recommended to use locations inside queries (e.g., bars, NY, USA) as the IP addresses of MapDataScraper's servers might be located in different countries.
            This endpoint is optimized for fast responses and can be used as real time API. Set the limit parameter to 20 to achieve the maximum response speed.
                    ...
                    Parameters:
                            ...
                            async_request (bool): parameter defines the way you want to submit your task to MapDataScraper. It can be set to `False` (default) to send a task and wait until you got your results, or `True` to submit your task and retrieve the results later using a request ID with `get_request_archive`. Each response is available for `2` hours after a request has been completed.
                            ...
                            webhook (str): parameter defines the URL address (callback) to which MapDataScraper will create a POST request with a JSON body once a task/request is finished. Using this parameter overwrites the webhook from integrations.

                    Returns:
                            list|dict: JSON result

            See: https://app.mapdatascraper.com/api-docs#tag/Google/paths/~1maps~1search-v3/get
        '''
    ...
    def google_maps_reviews(self, query: Union[list, str], reviews_limit: int = 10, limit: int = 1, sort: str = 'most_relevant',
        ...
        '''
            ...
            See: https://app.mapdatascraper.com/api-docs#tag/Google/paths/~1maps~1reviews-v3/get
        '''
        queries = as_list(query)
    ...
    def google_maps_photos(self, query: Union[list, str], photosLimit: int = 100, limit: int = 1, tag: str = None, language: str = 'en',
        ...
        '''
            ...
            See: https://app.mapdatascraper.com/api-docs#tag/Google/paths/~1maps~1photos-v3/get
        '''
        queries = as_list(query)
    ...
    def emails_and_contacts(self, query: Union[list, str], fields: Union[list, str] = None) -> list:
        '''
            Return email addresses, social links and phones from domains in seconds.
                    ...
                    Parameters:
                            query (list | str): Domains or links (e.g., mapdatascraper.com).
                            fields (list | str): Parameter defines which fields you want to include with each item returned in the response. By default, it returns all fields.

                    Returns:
                            list|dict: JSON result

            See: https://app.mapdatascraper.com/api-docs#tag/Email-Related/paths/~1emails-and-contacts/get
        '''
    ...
    def validate_emails(self, query: Union[list, str], async_request: bool = False) -> Union[list, dict]:
        '''
            ...
            Allows to validate email addresses. Checks if emails are deliverable.
                    ...
                    Parameters:
                            query (list | str): Email address (e.g., support@mapdatascraper.com).
                            async_request (bool): defines the way you want to submit your task to MapDataScraper. It can be set to `False` to send a task and wait for the results, or `True` to submit a task and retrieve results later using a request ID with `get_request_archive`.

                    Returns:
                            list|dict: JSON result

            See: https://app.mapdatascraper.com/api-docs#tag/Email-Related/paths/~1email-validator/get
        '''
        queries = as_list(query)
